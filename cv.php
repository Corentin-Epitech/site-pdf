    ...
    <body>
        ...
        <div id="form" class="form">
            ...
            <div id="comp" class="competences">
                ...
                <button type="button" id="comp-button" onclick="addText()">Ajouter</button>
            </div>
            <div id="experiences" class="exp">
                <h1>Expériences professionelles :</h1>
                <input class="nom-poste" type="text">
                <input class="nom-entreprise" type="text">
                <input class="exp-date" type="text">
                <input class="exp-date-fin" type="text">
                <textarea name="exp" id="desc-exp"></textarea>
                <button type="button" >Ajouter</button>
            </div>
            <div class="formations">
                <h1>Formations :</h1>
                <input class="nom-formations" type="text">
                <input class="etab" type="text">
                <input class="form-date" type="text">
                <input class="form-date-fin" type="text">
                <textarea class="desc-form" name="forma" id="desc-formation"></textarea>
                <button type="button" >Ajouter</button>
            </div>
