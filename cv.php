                ...
                <div class="info container">
                    <div class="row">
                        ...
                        <input class="nom" id="nom" type="text" name="nom"
                            oninput="document.getElementById('nom-preview').innerHTML = this.value" maxlength="20"
                             >
                        ...
                        <input class="mail" id="mail" type="email" name="mail"
                            oninput="document.getElementById('mail-preview').innerHTML = this.value" maxlength="100" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"
                            >
                        ...
                        <textarea class="desc" id="desc" name="desc"
                            oninput="document.getElementById('desc-preview').innerHTML = this.value" maxlength="200"
                            ></textarea>
                    </div>
                </div>
                <hr>
